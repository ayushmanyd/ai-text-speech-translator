...
export default function UseCases() {
  return (
    <section className="my-4 py-16 bg-black text-white text-center rounded-xl">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:px-16">
          {useCases.map((useCase, index) => (
            <div
              key={index}
              className="p-12 bg-gradient-to-br from-indigo-500/20 via-purple-500/10 to-pink-500/20 rounded-xl shadow-lg flex flex-col items-center text-center animateLeft"
            >
