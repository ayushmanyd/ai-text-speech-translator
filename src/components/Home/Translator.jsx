...
const TranslateSection = () => {
  ...
  return (
    <main>
      ...
      <div className="sm:flex sm:flex-col gap-8 lg:flex lg:flex-row">
        <div className="container flex flex-col mt-8">
          <div>
            <AILangRecognition />
          </div>
          <div className="mx-auto py-1 w-full h-auto text-foreground">
        ...
        <div className="container flex flex-col mt-8">
          ...
          <div className="mx-auto py-1 w-full h-auto flex items-center justify-end gap-2 text-foreground ">
